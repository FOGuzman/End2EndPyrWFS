...
PhotonNoise = 0;
nPhotonBackground = 1;%nInterval(rc);
quantumEfficiency = 1;
...
save(saveFold+"RNoisermseResults_noiser10.mat",'R')
...
R1 =load(loadFold+"RNoisermseResults_noiser10.mat");R1=R1.R;
loadFold = "../Preconditioners/nocap/pnoise/";
R2 =load(loadFold+"RNoisermseResults_noiser10.mat");R2=R2.R;
mod = 1;
