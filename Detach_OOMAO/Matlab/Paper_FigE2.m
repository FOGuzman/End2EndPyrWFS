...
savePath = "./ComputeResults/paper/FigE2/";if ~exist(savePath, 'dir'), mkdir(savePath); end
matName = "r0PerformanceFigE2";
FigurePath = "./figures/paper/FigureE2/";if ~exist(FigurePath, 'dir'), mkdir(FigurePath); end
FigureNameA = "fig_E2_rmse.pdf";
FigureNameB = "fig_E2_SD.pdf";
Compute = false;
