...
DPWFSn_path = "../Preconditioners/nocap/mod/OL1_R64_M2_RMSE0.005704_Epoch_109.mat";
FigurePath = "./figures/Figure9/";if ~exist(FigurePath, 'dir'), mkdir(FigurePath); end
...
fig = figure('Color','w','Position',[444 314.6000 975 447.4000]);
...
tx1.Position = [0.0550 0.8700 0.0673 0.1038];
tx2.Position = [0.4900 0.8700 0.0673 0.1038];
