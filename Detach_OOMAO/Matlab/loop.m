...
DPWFS_path = "D:/FOGuzman/End2EndPyrWFS/Detach_OOMAO/Preconditioners/n1_nico.mat";
%DPWFS_path = "../Preconditioners/nocap/mod/OL1_R64_M2_RMSE0.03355_Epoch_70.mat";

FigurePath = "./figures/LoopTest/";if ~exist(FigurePath, 'dir'), mkdir(FigurePath); end
FramesPath = "./figures/LoopTest/frames/";if ~exist(FramesPath, 'dir'), mkdir(FramesPath); end
...
PyrZ_buff = zeros(length(physicalParams.jModes),1);
NetZ_buff = PyrZ_buff;
for k = 1:numIter
+tel;
+ngs;
...
% Estimation
PyrZe = PyrZ_buff + gain*PyrCM*Pyr_y(:);
PyrZ_buff = PyrZe;
phi_hat1 = reshape(physicalParams.modes*PyrZe,[physicalParams.nPxPup physicalParams.nPxPup]);
...
% Estimation
NetZe = NetZ_buff + gain*DPWFS_CM*Net_y(:);
NetZ_buff = NetZe;
phi_hat2 = reshape(physicalParams.modes*NetZe,[physicalParams.nPxPup physicalParams.nPxPup]);
