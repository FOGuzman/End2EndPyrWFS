...
DPWFSr3_path = "../Pytorch/training_results/Paper/06-07-2023/r3_nico.mat";
DPWFSn1_path = "../Pytorch/training_results/Paper/06-07-2023/n1_nico.mat";
savePath = "./ComputeResults/paper/FigE1/";if ~exist(savePath, 'dir'), mkdir(savePath); end
matName = "r0PerformanceFigE1";
FigurePath = "./figures/paper/FigureE1/";if ~exist(FigurePath, 'dir'), mkdir(FigurePath); end
FigureNameA = "fig_E1_rmse.pdf";
FigureNameB = "fig_E1_SD.pdf";
Compute = false;
...
lbltxt{1} = sprintf("DPWFS-R1");
lbltxt{2} = sprintf("DPWFS-R2");
lbltxt{3} = sprintf("DPWFS-R3");

%lbltxt{4} = sprintf("DPWFS-N1");

lwd = 1.4;
fig = figure('Color','w','Units','normalized','Position',[0.5604 0.3083 0.2818 0.4120]);
hold on
plot(r0s,y1,'-b','LineWidth',lwd)
plot(r0s,y2,'-','LineWidth',lwd,'Color',[0 230 230]/255)
%plot(r0s,y3,'k','LineWidth',lwd)
plot(r0s,y3,'-','LineWidth',lwd,'Color',[0 180 0]/255)
