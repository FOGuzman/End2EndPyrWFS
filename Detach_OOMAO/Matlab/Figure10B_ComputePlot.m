...
%% Phisycal parameters
run("./tools/experiments_settings/F10_settings.m")
...
lbltxt{4} = sprintf("DPWFS, Mod $= %i\\lambda/D_0$",R(3).INFO.modulation);
...
plot(r0s,y4,'-ob','LineWidth',1.5,'MarkerFaceColor','r')
