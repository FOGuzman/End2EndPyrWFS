...
savePath = "./ComputeResults/paper/Fig10/";if ~exist(savePath, 'dir'), mkdir(savePath); end
matName = "r0PerformanceFig10A";
matName2 = "r0PerformanceFig10B";
FigurePath = "./figures/paper/Figure10/";if ~exist(FigurePath, 'dir'), mkdir(FigurePath); end
