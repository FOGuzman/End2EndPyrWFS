...
parser.add_argument('--saveMats', default="../Matlab/ComputeResults/paper/Fig8/", type=str)
...
cal_time = end-start
print(f"r0 Figure 8.A completed time({cal_time}) seg for {wfs.datapoints*wfs.dperR0*len(wfs.mods)} total data process.")



sio.savemat(wfs.saveMats+"r0PerformanceFig8A.mat", {'Results': Results},oned_as='row')
...
cal_time = end-start
print(f"r0 Figure 8.B completed time({cal_time}) seg for {wfs.datapoints*wfs.dperR0*len(wfs.mods)} total data process.")
