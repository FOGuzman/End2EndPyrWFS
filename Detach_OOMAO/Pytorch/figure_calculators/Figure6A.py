...
parser.add_argument('--dperR0', default=500, type=int, help='test per datapoint')

parser.add_argument('--models', nargs='+',default=['modelFastplusGCViT'])
...
RMSEdpwfs[0,:] = np.mean(ZFull[0],axis=0)
RMSEdpwfs[1,:] = np.std(ZFull[0],axis=0)
