...
parser.add_argument('--checkpoints', nargs='+',default=
                    ['/home/fg/Desktop/FOGuzman/End2EndPyrWFS/Detach_OOMAO/Pytorch/training_results/Paper/06-07-2023/original.mat',
                     ...
                     '/home/fg/Desktop/FOGuzman/End2EndPyrWFS/Detach_OOMAO/Pytorch/training_results/Paper/06-07-2023/pupil_15-40/checkpoint/PyrNet_epoch_99.pth',
                     '/home/fg/Desktop/FOGuzman/End2EndPyrWFS/Detach_OOMAO/Pytorch/training_results/Paper/06-07-2023/pupil_15-40_noise/checkpoint/PyrNet_epoch_99.pth'])
parser.add_argument('--saveMats', default="../Matlab/ComputeResults/paper/Fig10/", type=str)
...
cal_time = end-start
print(f"r0 Figure 10.A completed time({cal_time}) seg for {wfs.datapoints*wfs.dperR0*len(wfs.mods)} total data process.")



sio.savemat(wfs.saveMats+"r0PerformanceFig10A.mat", {'Results': Results},oned_as='row')
...
cal_time = end-start
print(f"r0 Figure 10.B completed time({cal_time}) seg for {wfs.datapoints*wfs.dperR0*len(wfs.mods)} total data process.")



sio.savemat(wfs.saveMats+"r0PerformanceFig8B.mat", {'ResultsN': ResultsN},oned_as='row')
