...
parser.add_argument('--data_batch', default=1, type=int, help='r0 intervals')
...
cal_time = end-start
print(f"r0 Figure 11 A completed time({cal_time}) seg for {wfs.datapoints*wfs.dperR0*len(wfs.mods)} total data process.")
