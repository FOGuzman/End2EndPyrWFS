...
parser.add_argument('--saveMats', default="../Matlab/ComputeResults/paper/FigE2/", type=str)
...
cal_time = end-start
print(f"r0 Figure E2 completed time({cal_time}) seg for {wfs.datapoints*wfs.dperR0*len(wfs.mods)} total data process.")



sio.savemat(wfs.saveMats+"r0PerformanceFigE2.mat", {'Results': Results},oned_as='row')