...
parser.add_argument('--data_batch', default=80, type=int, help='r0 intervals')
...
parser.add_argument('--saveMats', default= "../Matlab/ComputeResults/paperRR/Fig4/", type=str)
...
cal_time = end-start
print(f"r0 Figure 4 completed time({cal_time}) seg for {wfs.datapoints*wfs.dperR0*len(wfs.mods)} total data process.")



sio.savemat(wfs.saveMats+"r0PerformanceFig4.mat", {'Results': Results},oned_as='row')
