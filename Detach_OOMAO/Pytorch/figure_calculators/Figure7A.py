...
cal_time = end-start
print(f"r0 Figure 7 completed time({cal_time}) seg for {wfs.datapoints*wfs.dperR0*len(wfs.mods)} total data process.")



sio.savemat(wfs.saveMats+f"Dr0_{wfs.D_r0}_PerformanceFig7.mat", {'Results': Results},oned_as='row')
